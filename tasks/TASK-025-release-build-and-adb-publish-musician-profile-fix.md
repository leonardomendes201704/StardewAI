# TASK-025 - Publicar build release com correcoes no perfil do Musico
...
Gerar uma nova build `release` com a correcao da tela de perfil do Musico e publicar no device Android de homologacao via ADB Wi-Fi.

## Entregaveis previstos

- APK `release` atualizada com CTA fixo de salvamento
- remocao dos residuos visuais do bloco de preview do prototipo
...
- APK gerada com tamanho final de `31.770.582` bytes em `2026-04-07 18:46:38`
