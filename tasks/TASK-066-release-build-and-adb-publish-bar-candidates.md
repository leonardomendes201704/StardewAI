# TASK-066 - Publicar build release com candidatos e reputacao do Musico
...
Gerar a build `release` com a lista de candidatos no Bar e o detalhe do Musico com score/depoimentos, publicando essa versao no device Android de homologacao via ADB Wi-Fi.
