# TASK-101 - Publicar build release com hardening de origem das candidaturas
...
Gerar e instalar a build `release` com o client alinhado ao novo campo `source` das candidaturas.
