# TASK-031 - Publicar build release com CEP via ViaCEP no perfil do Musico
...
Gerar uma nova build `release` com o fluxo de CEP do perfil do Musico e publicar no device Android de homologacao via ADB Wi-Fi.

## Entregaveis previstos

- APK `release` atualizada com captura de CEP mascarado
...
- APK gerada com tamanho final de `31.774.342` bytes em `2026-04-07 19:07:10`
