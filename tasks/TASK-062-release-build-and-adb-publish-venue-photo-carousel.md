# TASK-062 - Publicar build release com carrossel de fotos no detalhe da vaga

Status: DONE
Inicio: 2026-04-08
Fim: 2026-04-08
Backlog relacionado: BKL-005, BKL-019, BKL-012, BKL-017

## Objetivo

Gerar a build `release` com o carrossel de fotos do Bar no detalhe da vaga e instalar no device Android de homologacao via ADB Wi-Fi.

## Entregaveis previstos

- `app-release.apk` atualizado com carrossel e viewer em tela cheia
